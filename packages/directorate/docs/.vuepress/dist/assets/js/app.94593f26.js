...
!(function (t) {
	...
	function (t, e, n) {
		Promise.all([n.e(0), n.e(11)]).then(n.t.bind(null, 10, 7));
	},
	function (t, e, n) {},
	function (t, e, n) {
		"use strict";
	...
	function (t, e, n) {
		...
		var ba = {
			...
			_a = {
				"v-62d25490": () => n.e(7).then(n.bind(null, 188)),
				"v-176f6ebe": () => n.e(6).then(n.bind(null, 189)),
				"v-4cb59b90": () => n.e(5).then(n.bind(null, 190)),
				"v-7fa67df8": () => n.e(8).then(n.bind(null, 191)),
				"v-60bc2bd8": () => n.e(10).then(n.bind(null, 192)),
				"v-73cc2483": () => n.e(9).then(n.bind(null, 193)),
			};
		function wa(t) {
		...
		const Xa = [
			...
			Qa = {
				...
				themeConfig: {
					...
					sidebar: { "/": ["", "Architecture", "Getting-started", "API", "Tutorials", "FAQ"] },
				},
			};
		n(6);
		No.component("Badge", () => Promise.all([n.e(0), n.e(3)]).then(n.bind(null, 194)));
		n(7);
		var Ja = n(4),
			Ya = n.n(Ja),
			Za = [
		...
		(window.__VUEPRESS__ = { version: "1.0.2", hash: "7fc899f" }),
			ls.onReady(() => {
				cs.$mount("#app");
			});
	},
