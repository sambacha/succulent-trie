...
*/
program.command("init").action(function (cmd) {
...
/*
  ...
  Start an Ora node
    -- Flag d: detached
*/
program.command("start").action(function (cmd) {
    console.log(chalk.green("Starting the node.... "));
    start();
});

program.command("build").action(function (cmd) {
...
/*
  ...
  Stop an Ora node
*/
program.command("stop").action(function (cmd) {
