...
_CURKELSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Create',
    full_name='CztrieService.Create',
    index=3,
    containing_service=None,
...
DESCRIPTOR.services_by_name['CztrieService'] = _CURKELSERVICE
